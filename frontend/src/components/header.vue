...
<div class="">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':this.headBg}">
		<div class="scene">
			<div><span id="luke"></span></div>
		</div>
		<div class="h-information">
			<a href="#/Aboutme">
                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:this.headTou" alt="">
                </a>
...
import tou from '../../static/img/tou.png'
export default {
	data() { //选项 / 数据
		return {
			userInfo: '', //用户信息
